...
function buildEvalSystemPrompt(): string {
  return [
    ...
    "- anti_genericity: did the turn AVOID both radio-DJ filler ('big play here') AND writerly LLM filler ('team scoring leverage,' 'cherish the six and a half,' 'credit where it's due')? (10 = sports-radio register only; 0 = either kind of filler)",
