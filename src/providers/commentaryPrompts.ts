...
const OUTPUT_SCHEMA_BLOCK = [
  ...
  "  ]",
  "}",
  "CLARITY RULE (load-bearing — the listener has NO shared context with the hosts):",
  "- Every turn must stand on its own. A listener tuning in for the first time should understand what the hosts are talking about without backstory.",
  "- Numbers get UNITS and PERIODS. NEVER write 'Through three?' or 'six assists' or 'eighteen percent' on their own. Write 'Through three quarters' / 'six assists in the half' / 'eighteen percent target share.' If the unit is obvious from context, say it anyway — listeners aren't squinting at a stat sheet.",
  "- Analyst shorthand needs UNPACKING or REPLACEMENT. 'Playmaker lift, not a scorer bump' / 'Six assists turn into other guys' ceilings' are stat-jargon that READ as confident but COMMUNICATE nothing. Replace with the plain-English version: 'When Shai's distributing, his teammates eat — the points go to other guys.'",
  "- Bare contradiction without context is aimless. 'Mmhmm' / 'Sure' / 'Yeah, no' work as REACTIONS to a clear prior take. They DON'T work as openers or standalone takes — the listener has nothing to attach them to.",
  "- Test: can a fan who just turned on the radio mid-show follow this turn? If no, rewrite. The dryest possible turn ('Mmhmm.') is fine; the dryest UNDERSTANDABLE turn is the bar.",
  "",
